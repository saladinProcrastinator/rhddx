...
## Centered
Add `centered` to `<div class="component rhd-c-card-grid pf-c-content">`
...
## Gray
Add `gray` to `<div class="component rhd-c-card-grid pf-c-content">`.
...
## No Padding (Bottom)
Add `no-padding-bottom` to `<div class="component rhd-c-card-grid pf-c-content">`
<div class="component rhd-c-card-grid pf-c-content pf-u-pb-0">
  <div class="pf-l-flex">
    <h2 class="pf-c-title">Title for Assembly with Card Grid</h2>
  </div>
  <div class="pf-l-flex rhd-c-card-grid__wrapper">
...
## No Padding (Top)
Add `no-padding-top` to `<div class="component rhd-c-card-grid pf-c-content">`

<div class="component rhd-c-card-grid pf-c-content pf-u-pt-0">
  <div class="pf-l-flex">
    <h2 class="pf-c-title">Title for Assembly with Card Grid</h2>
  </div>
  <div class="pf-l-flex rhd-c-card-grid__wrapper">
